            ...
            <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div>
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                            ...
                            name="color"
                            className="focus:ring-sunray focus:border-sunray flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                            placeholder="Enter the body color..."
                        />
                    </div>
                </div>
                <div>
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                            ...
                            className="focus:ring-sunray focus:border-sunray flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                            placeholder="Enter the vehicle's engine size..."
                        />
                    </div>
                </div>
                <div>
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                            ...
                            name="engine_power"
                            className="focus:ring-sunray focus:border-sunray flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                            placeholder="Enter the vehicle's declared horsepower..."
                        />
                    </div>
                </div>
                <div>
                    ...
                    >
                       \
                        <option value="GASOL">Petrol</option>
                ...
                <div>
                    ...
                    <Select
                        ...
                        name="emission_class"
                    >
                        <option value="EURO1">BS 1</option>
                        <option value="EURO2">BS 2</option>
                        <option value="EURO3">BS 3</option>
                        <option value="EURO4">BS 4</option>
                        <option value="EURO5">BS 5</option>
                        <option value="EURO6">BS 6</option>
                    </Select>
                </div>
                <div>
                    <label htmlFor="name" className="block text-base font-medium text-gray-700 mb-1">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                            ...
                            name="seats"
                            className="focus:ring-sunray focus:border-sunray flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                            placeholder="Enter the number of seats in your vehicle..."
                        />
                    </div>
                </div>
                {/* Has Image? */}
